...
# ==============================================================================
# HERRAMIENTAS AUXILIARES - v0.9.8m
# ==============================================================================
...
def estimar_peso_texto(texto):
    """
    Calcula una estimación de tokens y devuelve una tupla con metadata de carga.
    Regla general: 1 token ~= 4 caracteres.
    Retorna: (cantidad_tokens, etiqueta_texto, color_hex)
    """
    if not texto: return (0, "Vacío", "gray")
    
    n_tokens = len(texto) // 4
    
    if n_tokens < 30000:
        return (n_tokens, "Carga Ligera 🟢", "#4CAF50") # Verde
    elif n_tokens < 80000:
        return (n_tokens, "Carga Media 🟡", "#FFA000")  # Naranja
    else:
        return (n_tokens, "Carga Pesada 🔴 (Posible Latencia)", "#FF5555") # Rojo
